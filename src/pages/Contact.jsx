      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="flex gap-4 mb-8">
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-80 text-indigo-700 dark:bg-indigo-200/20 dark:text-indigo-500 font-medium hover:bg-indigo-100 dark:hover:bg-indigo-600/30 transition shadow"
          >
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-50 text-indigo-700 dark:bg-indigo-200/20 dark:text-indigo-500 font-medium hover:bg-indigo-100 dark:hover:bg-indigo-600/30 transition shadow"
          >
