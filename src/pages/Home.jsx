...
export default function Home() {
  ...
  <div className="min-h-screen bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-slate-100 transition-colors">
      {/* Hero Section */}
  <section className="flex flex-col items-center justify-center text-center py-24 px-6 bg-gradient-to-r from-gray-800 via-gray-700 to-gray-900 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-white">
        ...
        <div className="flex gap-4">
          <Link to="/resume">
            <Button className="bg-white text-gray-800 hover:bg-gray-100 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 shadow">
              <FileText size={18}/> View Resume
            </Button>
          </Link>
          <Link to="/contact">
            <Button className="bg-brand-orange-500 hover:bg-brand-orange-600 dark:bg-brand-orange-500 dark:hover:bg-brand-orange-600 shadow text-white dark:text-white">
  ...
  <section className="py-20 px-6 max-w-6xl mx-auto">
            ...
            <Link key={cs.slug} to={`/case/${cs.slug}`} className="block h-96">
              <div className="h-full flex flex-col rounded-2xl border bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 shadow hover:shadow-lg transition">
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="inline-flex text-sm underline text-brand-orange-600 dark:text-brand-orange-400">View Case Study</div>
                </div>
              </div>
            </Link>
          ))}
      ...
      {/* <section className="py-20 px-6 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-start md:items-center justify-center text-left md:text-center rounded-2xl border border-dashed bg-white/70 px-8 py-12">
          <div className="text-sm mb-3 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-orange-100 text-brand-orange-700 font-medium">🚧 Updating</div>
          ...
          <div className="flex flex-wrap gap-4 justify-start md:justify-center">
            <Link to="/resume" className="rounded-xl bg-brand-orange-500 text-white text-sm font-medium px-4 py-2 hover:bg-brand-orange-600 transition">View Resume</Link>
            <Link to="/contact" className="rounded-xl border text-sm font-medium px-4 py-2 hover:bg-gray-100 transition">Get in Touch</Link>
          </div>
        </div>
      </section> */}
    ...
    <section className="bg-white dark:bg-slate-800 py-20 px-6 border-t border-b border-transparent dark:border-slate-700/50">
      ...
      <p className="text-lg text-gray-700 dark:text-slate-300 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4 justify-start justify-center mt-6">
            <Link to="/about" className="rounded-xl bg-brand-orange-500 text-white text-sm font-medium px-5 py-2 hover:bg-brand-orange-600 transition">My Story</Link>
          </div>
        </div>
      </section>
    </div>
